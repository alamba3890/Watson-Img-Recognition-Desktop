...
class WowFormInputForm extends React.Component {
  ...
  render() {
    ...
    return (<tr style={baseStyle} className="base--tr">
      ...
      <label><em className="base--em"></em></label>
      <input type='hidden' name='category' value={this.props.category}/>
      
      <label htmlFor={this.props.name +'-yes'} className="base--inline-label results-table--input-yes-label"></label>
      
      <label htmlFor={this.props.name + '-no'} className="base--inline-label results-table--input-no-label"></label>
    </span>
            </td>
          </tr>);
  }
